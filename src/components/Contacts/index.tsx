...
export const Contacts = () => {
  ...
  return (
    <section className="w-full min-h-[45rem] h-auto bg-white p-8 md:p-16 overflow-hidden">
      <div className="container grid grid-cols-6 gap-8 items-center mx-auto">
            ...
            <div className="col-span-2 md:col-span-1 min-h-72 h-auto p-4 bg-blue-950 rounded-xl flex flex-col justify-center gap-2" data-aos="fade-up" data-aos-duration="3000">
              <div className="flex items-center gap-2">
                ...
                <div className="col-span-3 flex flex-col items-start justify-center mt-2">
                  <h2 className="text-lg text-white font-semibold">{language ? 'Endereço' : 'Address'}</h2>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="col-span-3 flex flex-col items-start justify-center mt-2">
                  <h2 className="text-lg text-white font-semibold">{language ? 'Telefone' : 'Phone'}</h2>
        ...
        <form className="col-span-6 md:col-span-3 space-y-3 md:p-6 " data-aos="zoom-in" data-aos-duration="3000">
          <h1 className="text-3xl font-bold text-neutral-900 mb-4 text-center md-text-start">
            {language ? 'Entre em contato conosco' : 'Get in touch with us'}
          </h1>

          <div className="flex flex-col w-full items-start justify-center gap-3">
            <Label>{language ? 'Nome:' : 'Name:'}</Label>
            <Input placeholder={language ? 'Digite seu nome' : 'Enter your name'} className="w-full bg-neutral-50 shadow-lg p-5" />
          </div>

          <div className="flex flex-col w-full items-start justify-center gap-3">
            <Label>Email:</Label>
            <Input type="email" placeholder={language ? 'Digite seu email' : 'Enter your email'} className="w-full bg-neutral-50 shadow-lg p-5" />
          </div>

          <div className="flex flex-col w-full items-start justify-center gap-3">
            <Label>{language ? 'Telefone:' : 'Phone:'}</Label>
            <Input type="tel" placeholder={language ? 'Digite seu telefone' : 'Enter your phone'} className="w-full bg-neutral-50 shadow-lg p-5" />
          </div>

          <div className="flex flex-col w-full items-start justify-center gap-3">
            <Label>{language ? 'Mensagem:' : 'Message:'}</Label>
            <Textarea placeholder={language ? 'Digite sua dúvida' : 'Type your message'} className="w-full h-28 bg-neutral-50 shadow-lg p-5" />
          </div>
